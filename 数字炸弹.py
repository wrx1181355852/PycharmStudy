...
class Boom:
    def __init__(self):
        ...
        self.num = random.randint(self.minNum, self.maxNum + 1)  # 数值范围
        ...
        self.layout = [  # 定义界面
            ...
            [sg.In(size=(30, 1), focus=True, do_not_clear=False, key='-IN-')],
    ...
    def mian(self):
        ...
        while True:
            ...
            if event == '刷新':  # 刷新程序重新开始
                ...
                # self.maxNum = self.maxding
                #
                # self.num = random.randint(self.minNum, self.maxNum+1)
